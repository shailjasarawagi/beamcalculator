export const draw_arrow_down_up2 = (svg, starting_position_x, starting_position_y, height_veritcal_line, length, i, j, k, l, x, z, difference, height1, height2) => {
    if (difference >= 700) {
        ...
        for (var x1 = 10, ra = starting_position_y + 10; x1 < difference / 3 && ra >= starting_position_y - height2; x1 = x1 + 30, ra = ra - 5) {
    ...
    if (difference < 700 && difference >= 600) {
        ...
        for (var x22 = 10, r22 = starting_position_y + 10; x22 < difference / 3 && r22 >= starting_position_y - height2; x22 = x22 + 30, r22 = r22 - 6) {
            let e = difference / 1.5
            svg.append("svg:line")
    ...
    if (difference < 600 && difference >= 450) {
        for (var x3 = 10, r3 = starting_position_y + height1; x3 < difference / 2 && r3 >= starting_position_y - height2; x3 = x3 + 30, r3 = r3 - 6.3) {
            svg.append("svg:line")
        ...
        for (var x33 = 10, r33 = starting_position_y + 10; x33 < difference / 3 && r33 >= starting_position_y - height2; x33 = x33 + 30, r33 = r33 - 8) {
            let e = difference / 1.5
            svg.append("svg:line")
    ...
    if (difference < 450 && difference >= 350) {
        for (var x4 = 10, r4 = starting_position_y + height1; x4 < difference / 2 && r4 >= starting_position_y - height2; x4 = x4 + 30, r4 = r4 - 9) {
            svg.append("svg:line")
        ...
        for (var x44 = 10, r44 = starting_position_y + 10; x44 < difference / 3 && r44 >= starting_position_y - height2; x44 = x44 + 30, r44 = r44 - 10) {
            let e = difference / 1.5
            svg.append("svg:line")
    ...
    if (difference < 350 && difference >= 250) {
        for (var x5 = 10, r5 = starting_position_y + height1; x5 < difference / 2 && r5 >= starting_position_y - height2; x5 = x5 + 30, r5 = r5 - 11.5) {
            svg.append("svg:line")
        ...
        for (var x55 = 10, r55 = starting_position_y + 10; x55 < difference / 3 && r55 >= starting_position_y - height2; x55 = x55 + 30, r55 = r55 - 14) {
            let e = difference / 1.5
            svg.append("svg:line")
    ...
    if (difference < 250 && difference >= 200) {
        for (var x6 = 10, r6 = starting_position_y + height1; x6 < difference / 2 && r6 >= starting_position_y - height2; x6 = x6 + 30, r6 = r6 - 16) {
            svg.append("svg:line")
        ...
        for (var x66 = 10, r66 = starting_position_y + 10; x66 < difference / 3 && r66 >= starting_position_y - height2; x66 = x66 + 30, r66 = r66 - 19) {
            let e = difference / 1.5
            svg.append("svg:line")
    ...
    if (difference < 200 && difference >= 170) {
        for (var x7 = 10, r7 = starting_position_y + height1; x7 < difference / 2 && r7 >= starting_position_y - height2; x7 = x7 + 30, r7 = r7 - 18) {
            svg.append("svg:line")
        ...
        for (var x77 = 10, r77 = starting_position_y + 10; x77 < difference / 3 && r77 >= starting_position_y - height2; x77 = x77 + 30, r77 = r77 - 25) {
            let e = difference / 1.5
            svg.append("svg:line")

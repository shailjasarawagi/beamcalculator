export const draw_arrow_down_up2 = (svg, starting_position_x, starting_position_y, height_veritcal_line, length, i, j, k, l, x, z, difference, height1, height2) => {
    ...
    if (difference < 700 && difference >= 600) {
        ...
        for (var x22 = 10, r22 = starting_position_y - height1; x22 < difference / 2 && r22 <= starting_position_y + height2; x22 = x22 + 30, r22 = r22 + 4) {
            svg.append("svg:line")
    ...
    if (difference < 600 && difference >= 450) {
        ...
        for (var x33 = 10, r33 = starting_position_y - height1; x33 < difference / 2 && r33 <= starting_position_y + height2; x33 = x33 + 30, r33 = r33 + 4.5) {
            svg.append("svg:line")
    ...
    if (difference < 450 && difference >= 350) {
        ...
        for (var x44 = 10, r44 = starting_position_y - height1; x44 < difference / 2 && r44 <= starting_position_y + height2; x44 = x44 + 30, r44 = r44 + 4.5) {
            svg.append("svg:line")
    ...
    if (difference < 350 && difference >= 250) {
        ...
        for (var x55 = 10, r55 = starting_position_y - height1; x55 < difference / 2 && r55 <= starting_position_y + height2; x55 = x55 + 30, r55 = r55 + 8) {
            svg.append("svg:line")
    ...
    if (difference < 250 && difference >= 200) {
        for (var x6 = 10, r6 = starting_position_y + 10; x6 < difference / 2 && r6 <= starting_position_y + height2; x6 = x6 + 30, r6 = r6 + 11) {
            let e = difference / 1.4
            // console.log(ra)
            svg.append("svg:line")
        ...
        for (var x66 = 10, r66 = starting_position_y - height1; x66 < difference / 2 && r66 <= starting_position_y + height2; x66 = x66 + 30, r66 = r66 + 9) {
            svg.append("svg:line")
    ...
    if (difference < 200 && difference >= 150) {
        ...
        for (var x77 = 10, r77 = starting_position_y - height1; x77 < difference / 2 && r77 <= starting_position_y + height2; x77 = x77 + 30, r77 = r77 + 15) {
            svg.append("svg:line")
    ...
    if (difference < 150 && difference >= 100) {
        for (var x8 = 10, r8 = starting_position_y + 10; x8 < difference / 2 && r8 <= starting_position_y + height2; x8 = x8 + 30, r8 = r8 + 13) {
            let e = difference / 1.4
            // console.log(ra)
            svg.append("svg:line")
        ...
        for (var x88 = 10, r88 = starting_position_y - height1; x88 < difference / 2 && r88 <= starting_position_y + height2; x88 = x88 + 30, r88 = r88 + 13) {
            svg.append("svg:line")

export const draw_arrow_down_up1 = (svg, starting_position_x, starting_position_y, height_veritcal_line, length, i, j, k, l, x, z, difference, height1, height2) => {
    ...
    if (difference < 700 && difference >= 600) {
        for (var x2 = 10, r2 = starting_position_y + 10; x2 < difference / 2 && r2 <= starting_position_y + height2; x2 = x2 + 30, r2 = r2 + 3.5) {
            let e = difference / 2
            // console.log(ra)
            svg.append("svg:line")
    ...
    if (difference < 600 && difference >= 450) {
        ...
        for (var x33 = 10, r33 = starting_position_y - height1; x33 < difference / 3 && r33 <= starting_position_y + height2; x33 = x33 + 30, r33 = r33 + 4) {
            svg.append("svg:line")
    ...
    if (difference < 450 && difference >= 350) {
        for (var x4 = 10, r4 = starting_position_y + 10; x4 < difference / 2 && r4 <= starting_position_y + height2; x4 = x4 + 30, r4 = r4 + 9) {
            let e = difference / 2
            // console.log(ra)
            svg.append("svg:line")
    ...
    if (difference < 350 && difference >= 250) {
        for (var x5 = 10, r5 = starting_position_y + 10; x5 < difference / 2 && r5 <= starting_position_y + height2; x5 = x5 + 30, r5 = r5 + 12) {
            let e = difference / 2
            // console.log(ra)
            svg.append("svg:line")
        ...
        for (var x55 = 10, r55 = starting_position_y - height1; x55 < difference / 3 && r55 <= starting_position_y + height2; x55 = x55 + 30, r55 = r55 + 7) {
            svg.append("svg:line")
    ...
    if (difference < 250 && difference >= 200) {
        for (var x6 = 10, r6 = starting_position_y + 10; x6 < difference / 2 && r6 <= starting_position_y + height2; x6 = x6 + 30, r6 = r6 + 17) {
            let e = difference / 2
            // console.log(ra)
            svg.append("svg:line")
        ...
        for (var x66 = 10, r66 = starting_position_y - height1; x66 < difference / 3 && r66 <= starting_position_y + height2; x66 = x66 + 30, r66 = r66 + 9) {
            svg.append("svg:line")
    ...
    if (difference < 200 && difference >= 150) {
        for (var x7 = 10, r7 = starting_position_y + 10; x7 < difference / 2 && r7 <= starting_position_y + height2; x7 = x7 + 30, r7 = r7 + 18) {
            let e = difference / 2
            // console.log(ra)
            svg.append("svg:line")
        ...
        for (var x77 = 10, r77 = starting_position_y - height1; x77 < difference / 3 && r77 <= starting_position_y + height2; x77 = x77 + 30, r77 = r77 + 11) {
            svg.append("svg:line")
    ...
    if (difference < 150 && difference >= 100) {
        for (var x8 = 10, r8 = starting_position_y + 10; x8 < difference / 2 && r8 <= starting_position_y + height2; x8 = x8 + 30, r8 = r8 + 22) {
            let e = difference / 2
            // console.log(ra)
            svg.append("svg:line")
                .attr("x1", starting_position_x + e + x8)
                .attr("y1", starting_position_y + 10)
                .attr("x2", starting_position_x + x8 + e + 2.5)
                .attr("y2", starting_position_y + 10 + 6)
                .style("stroke", "black");

            svg.append("svg:line")
                .attr("x1", starting_position_x + x8 + e)
                .attr("y1", starting_position_y + 10)
                .attr("x2", starting_position_x + x8 + e - 2.5)
                .attr("y2", starting_position_y + 6 + 10)
                .style("stroke", "black");
            ...
            svg.append("svg:line")
                .attr("x1", starting_position_x + x8 + e)
                .attr("y1", starting_position_y + 10)
                .attr("x2", starting_position_x + x8 + e)
                .attr("y2", r8)
                .style("stroke", "black");
        }
        for (var x88 = 10, r88 = starting_position_y - height1; x88 < difference / 3 && r88 <= starting_position_y + height2; x88 = x88 + 30, r88 = r88 + 18) {
            svg.append("svg:line")
                .attr("x1", starting_position_x + x88)
                .attr("y1", starting_position_y + 10)
                .attr("x2", starting_position_x + x88 + 3.5)
                .attr("y2", starting_position_y)
                .style("stroke", "black");
            ...
            svg.append("svg:line")
                .attr("x1", starting_position_x + x88)
                .attr("y1", starting_position_y + 10)
                .attr("x2", starting_position_x + x88)
                .attr("y2", r88)
                .style("stroke", "black");
        }
